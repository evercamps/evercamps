...
export default function Registrations({ participant, addRegistrationUrl }: Props) {
  ...
  const removeRegistration = async (api: string, uuid: string) => {
            ...
            >
              <div className="modal">
                <AddRegistrations
                  ...
                  addedProductIDs={data?.participant.registrations?.items?.map((r: any) => r.productId) || []}
                />
              </div>
            </div>
          </div>
            ...
            {data && (
              <>
                ...
                <div className="divide-y">
                  {data.participant.registrations.items.map((r: any) => {
                    const p = r;
                    return (
                      <div
                      ...
                      >
                        ...
                        <div className="col-span-2 text-right">
                          <a
                            ...
                            onClick={async (e) => {
                              e.preventDefault();
                              await removeRegistration(r.deleteApi, r.uuid);
                            }}
